...
tf.app.flags.DEFINE_string('version', 'test_20', '''A version number defining the directory to save
...
tf.app.flags.DEFINE_integer('train_steps', 1, '''Total steps that you want to train''')
...
tf.app.flags.DEFINE_integer('validation_batch_size', 1, '''Validation batch size, better to be
...
tf.app.flags.DEFINE_string('ckpt_path', './saves/model_resnet20.ckpt', '''Checkpoint
directory to restore''')
tf.app.flags.DEFINE_boolean('is_use_ckpt', False, '''Whether to load a checkpoint and continue
training''')

tf.app.flags.DEFINE_string('test_ckpt_path', './logs_test_20/model.ckpt-0', '''Checkpoint
directory to restore''')
